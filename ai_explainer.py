"""
ai_explainer.py - AI Explanation Panel
Creates human-readable AI explanations for detections and measurements.
"""
    ...
    def build_explanation(self, measurement: dict, mode: str = "EST"):
        ...
        if width is None or height is None:
            ...
            if accuracy == "Estimated" or mode == "EST":
                size_text = f"Estimated dimensions: width ≈ {width} cm, height ≈ {height} cm."
            else:
                size_text = f"Accurate measurements: width = {width} cm, height = {height} cm."

        # Object type specific explanation
        ...
        if mode == "ACC":
            ...
            mode_text = "⚠️ ESTIMATED MODE: No calibration active. Show a bank card for accurate measurements."
