...
class StateManager:
    ...
    def load_state(self):
        default_state = {
            "version": "5.1", "voice_enabled": True, "last_units": "cm",
            "last_camera_id": 0, "last_model_path": "models/yolov8n.pt",
            "confidence_threshold": 0.40, "window_geometry": "1440x860",
            "window_position": None, "last_export_folder": "exports",
            "auto_save_enabled": False, "last_calibration_ppc": None,
            "last_used_features": {"barcode": True, "tracking": True, "voice": True, "tapmap": False},
            "user_preferences": {"show_measurement_lines": True, "show_accuracy_bar": True, "animation_speed": 15, "theme": "dark"},
            "session_history": [], "total_sessions": 0, "last_session": None, "first_run": True
        }
