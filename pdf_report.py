...
AI Measure Pro YOLO - Version 2

Uses reportlab to generate a professional measurement report PDF.
"""
...
def generate_pdf_report(measurements: list, screenshot_frame=None, output_path: str = None) -> str:
    """
    Generate a PDF measurement report.
    """
    ...
    story.append(Paragraph("Measurement Report — Version 2", subtitle_style))
    ...
    notes = [
        "<b>High accuracy</b>: 8+ frames averaged, key landmarks clearly visible.",
        "<b>Medium accuracy</b>: 4-7 frames, partial visibility.",
        "<b>Low accuracy</b>: Few frames collected; hold still for better results.",
    ...
    story.append(Spacer(1, 0.5 * cm))
    story.append(Paragraph(
        "AI Measure Pro YOLO V2  |  Powered by YOLOv8 + MediaPipe  |  For academic use",
        muted_style
    ))
