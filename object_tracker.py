"""
object_tracker.py - Multiple object tracking with persistent IDs
"""
...
class ObjectTracker:
    def __init__(self, max_age=30, max_history=20, iou_threshold=0.3):
        ...
        Args:
            max_age: Maximum frames before removing track
            max_history: Maximum measurement history per object
    ...
    def update(self, detections):
        ...
        for track_id, track in self.tracks.items():
            ...
            for i, det in enumerate(detections):
                ...
                # Label must match for high confidence
        ...
        for track_id, det_idx in matched_pairs:
            ...
            # Store measurement if available
        ...
        # Prepare output with smoothed measurements
        output = []
        for track_id, track in self.tracks.items():
            # Calculate average measurements from history
            avg_width = None
            avg_height = None
            ...
            output.append({
                ...
                "measurement_count": len(track["measurements"])
            })
        
        return output
    
    def get_track_history(self, track_id):
        """Get measurement history for a specific track"""
